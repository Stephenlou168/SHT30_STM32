...
/* USER CODE BEGIN PV */
#define SHT30_SENSOR_ADDR           (0x44   << 1)  // SHT30 sensor address
#define SHT30_MEAS_HIGHREP_STRETCH  0x2C06  // Measurement command for high repeatability with clock stretching
